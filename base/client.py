...
class FactorioContext(CommonContext):
    ...
    def __init__(self, server_address, password, filter_connection_changes: bool, filter_item_sends: bool, bridge_chat_out: bool,
                 ...
                 config_file: str, factorio_server_args: tuple[str, ...]):
...
def launch(*new_args: str):
    ...
    config_file = user_path('factorio', 'config', 'config.ini')

    if not os.path.exists(config_file):
        os.makedirs(os.path.dirname(config_file), exist_ok=True)

        read_path = '__PATH__executable__/../../data/'
        write_path = user_path('factorio')
