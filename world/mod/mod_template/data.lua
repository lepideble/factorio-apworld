...
data.raw["map-gen-presets"].default["archipelago"] = {{ dict_to_lua({"default": False, "order": "a", "basic_settings": world_generation["basic"], "advanced_settings": world_generation["advanced"]}) }}
