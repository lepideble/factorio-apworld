...
progressive_items_with_split_technologies = {
    ...
    'progressive circuit from scrap': ['recipe: electronic-circuit-from-scrap', 'recipe: advanced-circuit-from-scrap', 'recipe: processing-unit-from-scrap'],
    ...
    'progressive engine': ['recipe: engine-unit', 'recipe: electric-engine-unit'],
    'progressive engine-from-scrap': ['recipe: engine-unit-from-scrap', 'recipe: electric-engine-unit-from-scrap'],
