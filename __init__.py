...
def launch_client(*args: str):
    ...
    launch_component(launch, name=f"Factorio: {config.name} Client", args=args)


components.append(Component(f"Factorio: {config.name} Client", func=launch_client, component_type=Type.CLIENT))
...
class FactorioLocation(Location):
    game: str = f"Factorio: {config.name}"
